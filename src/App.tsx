...
import PreloaderHeart from "./components/PreloaderHeart";
  ...
  return (
      <>
        ...
        >
          ...
          <section className="relative flex w-full h-full justify-between items-center bg-[#f5f5f5]">
            <div className="max-w-3xl w-1/2 h-full min-h-[20rem] md:min-h-[25rem] bg-cover bg-right bg-no-repeat
                            bg-[url('/image/bg-list.webp')] scale-x-[-1] z-0 rotate-180">
            </div>
            <div
          ...
          <section className="flex w-full justify-center items-center bg-[#f5f5f5]">
          ...
          <section className="flex w-full h-full justify-between items-center bg-[#f5f5f5]">
          ...
          <section
              id="dresscode"
              className="relative flex w-full h-full justify-between items-center bg-[#f5f5f5]"
          >
            <div className="max-w-3xl w-1/2 h-full min-h-custom-15 md:min-h-[20rem] bg-cover bg-right bg-no-repeat
                            bg-[url('/image/bg-list.webp')] scale-x-[-1] rotate-180 z-0">
            </div>
            ...
            <div className="max-w-3xl w-1/2 h-full min-h-custom-15 md:min-h-[20rem] bg-cover bg-right bg-no-repeat
                            bg-[url('/image/bg-list.webp')] rotate-180 z-0">
            </div>
          </section>
          ...
          <section
              className="relative flex w-full min-h-[25rem] h-full justify-between items-center bg-[#f5f5f5]"
          >
